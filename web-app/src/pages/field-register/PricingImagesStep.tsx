...
import { DropIcon, DeleteIcon } from "../../assets/icons";
...
const PricingImagesStep: React.FC<PricingImagesStepProps> = ({
  formData,
  onChange,
}) => {
  ...
  const handleAddPriceSlot = (
    ...
    const fieldPricing =
      formData.pricing[fieldType as keyof typeof formData.pricing];
                  ...
                  <div className="pricing-table-container">
                    <div className="table-header">
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleAddPriceSlot(fieldType, "weekdays")
                        }
                      >
                        + Thêm khung giờ
                      </button>
                    ...
                    {pricing.weekdays.map((slot, index) => (
                      <div key={index} className="pricing-grid">
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleRemovePriceSlot(fieldType, "weekdays", index)
                          }
                        >
                  ...
                  <div className="pricing-table-container">
                    <div className="table-header">
                      ...
                      <button
                        className="add-slot-btn"
                        onClick={() =>
                          handleAddPriceSlot(fieldType, "weekends")
                        }
                      >
                        + Thêm khung giờ
                      </button>
                    ...
                    {pricing.weekends.map((slot, index) => (
                      <div key={index} className="pricing-grid">
                        ...
                        <button
                          className="remove-btn"
                          onClick={() =>
                            handleRemovePriceSlot(fieldType, "weekends", index)
                          }
                        >
                          <img src={DeleteIcon} alt="Delete" />
                        </button>
